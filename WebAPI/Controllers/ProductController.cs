...
namespace WebAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(AgroDbContext context)
        {
            db = context;
        }
        ...
        // GET: api/Products/5
        [HttpGet("{id}")]
        public ActionResult<ProductVM> GetProducts(int id)
        {
            var data = (from p in db.Products
                        select new ProductVM
                        {
        ...
        // POST: api/Products
        [HttpPost]
        public async Task<ActionResult<Products>> PostProducts([FromBody]ProductVM pvm)
        {
            Products p = new Products();
