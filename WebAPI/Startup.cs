...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //___AppDbConnection
            services.AddDbContext<AgroDbContext>(
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, AuthenticationContext context, UserManager<ApplicationUser> userManager,
